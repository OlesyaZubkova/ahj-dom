...
### Перемещение элемента [![Build status](https://ci.appveyor.com/api/projects/status/a509bf68lwk093dr?svg=true)](https://ci.appveyor.com/project/OlesyaZubkova/ahj-dom)
